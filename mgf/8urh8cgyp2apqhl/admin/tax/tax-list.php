          ...
          <div class="row">
            <div class="col-md-8">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Add New TAX Codes for my Bank</h4>
                  <p class="card-category">Please Enter Preferred TAX Codes</p>
                </div>
                <div class="card-body">
                   ...
                   <?php
                                                    ...
                                                    $sql = "INSERT INTO `tax` (`id`, `pin`, `type`) VALUES (NULL, '$pin', '$type')";
                                                    
                            						 
                            						   $insert=mysqli_query($conn, $sql);
                            						   
                            						   if($insert){
                            							   echo '<h3>TAX CODE WAS SUCCESSFUL!</h3>';
...
function validateForm() {
  ...
  if (x == "") {
    alert("Please Enter TAX in the field");
    return false;
  }
}
...
function validateForm() {
  ...
  if (x == "") {
    alert("Please Enter 5-10 digits TAX Code");
    return false;
  }
}
</script>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="type" id="type"  placeholder="TAX" >
		 ...
		 <input type="text"  class="input-block-level" placeholder="Captcha" name="" required >
              ...
              <br><br>
                    ...
                    <button type="submit" name="submit" class="btn warning">Add TAX Now</button>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">List of TAX Codes for my Bank</h4>
                  <p class="card-category">View account TAX Codes Avaliable</p>
                </div>
                <div class="card-body">
