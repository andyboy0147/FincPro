	...
	if (dbNumRows($result) == 1) {
		...
		dbQuery($sql);
						...
						$sender="INFO"; /* sender id */
            						$message=" $type Alert    Acc:$acc_no  Amt: US$ $amt   Desc: $desc   Time: $dot   Avail Bal: US$ $balance
            						"; /* message to be sent*/
                ...
                <tr>
                    <td bgcolor='#FFFFFF'>
                        ...
                        <table width='540' border='0' cellspacing='0' cellpadding='0' align='center' class='agile1 scale'>
                            ...
                            <tr><td class='wls-5h' style='color:green;'><h1><strong>Fincpro Group Limited</strong></h1></td></tr> 
                            ...
                            <tr><td height='12' style='font-size: 14px; color:green;'>TRANSACTION TYPE: &nbsp;&nbsp;&nbsp;&nbsp; $type</td></tr>
                             <tr><td height='12' style='font-size: 14px; color:green;'>AMOUNT: &nbsp;&nbsp;&nbsp;&nbsp; USD$ $amt</td></tr>
    	                    ...
    	                    <tr><td height='12' style='font-size: 22px; color:orange;'><strong>LEDGER BALANCE: &nbsp;&nbsp;&nbsp;&nbsp; USD$ $balance</strong></td></tr>
    	          
    	        
                             <tr><td class='wls-5h' height='60' style='font-size: 14px; color:red;'> Warm Regards,</td></tr> 
	                        
	                         <tr><td class='wls-5h' height='60' style='font-size: 18px; color:orange;'><strong>Fincpro Group Limited </strong></td></tr>
                            
                             
                            
                            <tr><td class='wls-5h' height='60'>
                             
	Declaimer: this message was automatically generated via Fincpro Group Limited   secured online channel, please do not reply this message. all
	correspondent should be address to Customer's Services
