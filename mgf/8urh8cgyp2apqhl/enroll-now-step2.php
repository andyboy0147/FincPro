		...
		<div class="main-panel">
			<div class="content">
				...
				<form  method="post" action="" autocomplete="off">
				 ...
				 <textarea name="terms" rows="12" readonly="readonly" cols="55" style="width: 700px;" autocomplete="off" >
...
- For your password, change it online as soon as possible.  If you have difficulty changing your password, you must phone us on Your Number
...
</textarea> <a href="enroll-now-step1.php"  style="color:yellow;" class="btn btn-secondary btn-round"  >Decline </a>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
