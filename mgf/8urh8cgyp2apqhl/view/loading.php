            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary"> 
                  <p class="card-category">You have requested to make a transfer to  <strong style="color:green;">&nbsp;&nbsp;<?php echo $_POST['rname']; ?>&nbsp;&nbsp;</strong> with account Number 
                  <strong style="color:green;">&nbsp;&nbsp;<?php echo $_POST['raccno']; ?>&nbsp;&nbsp;</strong>
                  and swiftcode:  <strong style="color:blue;">&nbsp;&nbsp;<?php echo $_POST['swiftcode']; ?>&nbsp;&nbsp;</strong>  initiated successfully, 
                  please wait 2-3 minutes for system to validate the beneficiary bank name : <strong style="color:brown;">&nbsp;&nbsp;<?php echo $_POST['rbnk']; ?>&nbsp;&nbsp;</strong> is recognized by International Monetary Funds. </p>
                </div>
                <div class="card-body">
