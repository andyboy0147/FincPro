...
<p style="text-align:center; color:green;"><img src="<?php echo WEB_ROOT; ?>include/assets/logo-ok-png-2.png" width="100" ></a></p>
                    ...
                    <h1 style="text-align:center; color:orange;"><strong>USD$ <?php echo $amt; ?>.00</strong></h1>
                    
                    <p style="text-align:center;">You have successfully transferred USD$ <?php echo $amt; ?>.00 to <?php echo $acc_no; ?> of  <?php echo $rname; ?> . Transaction Reference Number# <?php echo $_SESSION['funds_data']['tx_no']; ?>FCNB </p>

                    
                    <p style="text-align:center; color:blue;">International transaction initiated successfully, it will take 2-3 working days to credit funds in receivers account.
...
<table  border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
	...
	<tr>
        ...
        <td height="30"><?php echo $_SESSION['funds_data']['tx_no']; ?>FCNB</td>
	</tr>
</table>
