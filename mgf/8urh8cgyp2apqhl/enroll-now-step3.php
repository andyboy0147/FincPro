...
<head>
	...
	<link rel="icon" href="include/assets/icon.png" type="image/png"/>
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="" class="logo">
					<img src="include/assets/logo.png"  height="70px" width="100px" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="contact-us.php" class="btn btn-secondary btn-round">Get Help </a>
							</div>
						</div>
					</div>
				</div>
...
<div style="overflow-x:auto;">
				<table>
				<tr><td colspan="3"><strong style="color:green;">PERSONAL INFORMATION (all fields are Compulsory)</strong></td></tr>
				
				<tr>
					<td>
					 <span id="sprytf_firstname">
					<input type="text" name="firstname" placeholder="Legal First Name" class="form-first-name form-control" id="email">
					  <br/>
					...
					<input type="text" name="lastname" placeholder="Legal Last Name" class="form-first-name form-control" id="email">
					  <br/>
			...
			<span class="textfieldMinCharsMsg">Lastname must specify at least 6 characters.</span>
				...
				<tr>
					...
					<td>
					    <label>Please select Genger:</label>
				...
				<tr><td colspan="3">&nbsp;</td></tr>	 
											...
											<tr><td colspan="3"><strong style="color:brown;">EMPLOYMENT SECTION (Incase of Loan/Facility)</strong></td></tr>
				<tr>
					<td colspan="3">
					  	<input type="text" name="empname" placeholder="Name and Address of Employer" class="form-last-name form-control" id="form-last-name">
				...
				<tr><td colspan="3"><strong style="color:red;" >NEXT OF KIN DETAILS (Beneficiary)</strong></td></tr>
				<tr>
					<td>
					<input type="text" name="bname" placeholder="Beneficiary Legal Name" class="form-first-name form-control" id="form-first-name">
					</td>
					 
					<td>
					<input type="text" name="boccu" placeholder="Beneficiary Occupation" class="form-first-name form-control" id="form-first-name">
					</td>
				...
				<tr>
					<td>
					<input type="text" name="bemail" placeholder="Beneficiary Email Address" class="form-first-name form-control" id="form-first-name">
					</td>
				 
					<td>
					<input type="text" name="bmobile" placeholder="Beneficiary Mobile Number" class="form-first-name form-control" id="form-first-name">
					</td>
				...
				<tr>
					...
					<label>Your Passport photograph</label>
					 <input type="file" class="btn btn-secondary btn-round" id="form-first-name" name="pic"  />
					</td>
				</tr>
					<tr><td>&nbsp;</td></tr>
				<tr>
