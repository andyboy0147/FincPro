...
<table width='100%' border='0' cellspacing='0' cellpadding='0' align='center'>
                        ...
                        <table width='540' border='0' cellspacing='0' cellpadding='0' align='center' class='agile1 scale'>
                            ...
                            <tr>
                                <td class='w3l-p2' style='font-family: Candara, sans-serif; color: #7f8c8d; font-size: 18px; line-height: 28px;' class='scale-center-both'>
                                   A user from the above mentioned IP accessed your account via our online banking channel and we felt it important to notify you for security 
             reasons and to further protect your account against internet and cyber crimes. Please kindly notify our customer services if your are not the one who accessed your 
	...
	correspondent should be address to Customer Services
	...
	send_email($mail_data);
		...
		$errorMessage = '
		<p style="text-align:justify; color:orange;">Dear Customer, <br/> we have discovered suspicious activities in your account; because an unauthorized IP
...
//	$accno 	= (int)$_POST['accno']; 
	...
	$result = dbQuery($sql);
	if (dbNumRows($result) == 1) {
		$errorMessage = 'Fincpro Group Customer with the username already exist, please try another name.';
		return $errorMessage;
	}
...
'$bmobile', '$brela', '$bage', '$badd', '$q1', '$q2', '$ans1', '$ans2',	PASSWORD('$pwd'),'FALSE', 'USER', '$thumbnail', NOW())";	
	...
	dbQuery($sql);
						...
						$sender="INFO"; /* sender id */
            						$message="Dear $fname, You have successfully enrolled for Fincpro Group, Your A/C NO is $accno
            						"; /* message to be sent*/
