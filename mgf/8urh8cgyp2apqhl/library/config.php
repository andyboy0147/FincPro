...
$dbHost = 'localhost';
$dbUser = 'fincprog_fincprog';
$dbPass = 'mopuru01@';
$dbName = 'fincprog_fincprog';

//ONLINE BANKING DATA SETTINGS
$site_title = 'Fincpro Group';
$site_address = 'GCF Roseland Ave Austine #72222 TX USA';
$site_initial = 'FPG';
$site_currency = '$';



$email_id = 'support@fincpro-groupltd.com';
