				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Acknwoledgment Successful</h2>
								<h5 class="text-white op-7 mb-2">Step 4/4</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="contact-us.php" class="btn btn-white btn-border btn-round mr-2">Get Help</a>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
                                         ...
                                         <p>Dear <strong style="color:green;">Customer,</strong> Please wait till Our Customer Service validate your account, 
                                         then you can login to you account.</p>
                    		  <p>This Process can take <strong style="color:green;">1-2 business working days</strong>, once your account is validated, you will be notify through your registered 
                    		  email address</p>
